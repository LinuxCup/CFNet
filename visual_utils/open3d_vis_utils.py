...
def draw_scenes(points, pred_panoptic, kitti_cfg, gt_boxes=None, ref_boxes=None, ref_labels=None, ref_scores=None, point_colors=None, draw_origin=True):
    ...
    if point_colors is None:
        ...
        color_dict = kitti_cfg["color_map_learning"]
    ...
    #     point_colors[ins_mask] = color_dict[i%16]
