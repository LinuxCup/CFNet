...
def get_config():
    class General:
        ...
        category_list = ['barrier', 'bicycle', 'bus', 'car', 'construction_vehicle', 'motorcycle', 'pedestrian', 'traffic_cone', 
        ...
        class Voxel:
            RV_theta = (-31.34, 11.33) #https://velodynelidar.com/wp-content/uploads/2019/12/97-0038-Rev-N-97-0038-DATASHEETWEBHDL32E_Web.pdf
            range_x = (-48.0,48.0)
            range_y = (-48.0,48.0)
            range_z = (-4.0,1.5)
    ...
    class DatasetParam:
        class Train:
            data_src = 'data'
            num_workers = 2
            frame_point_num = 50000
            SeqDir = General.SeqDir
            Voxel = General.Voxel
            center_type = General.center_type
            class CopyPasteAug:
                is_use = False
                ObjBackDir = '/data/datasets/object_bank_semkitti'
    ...
    class OptimizeParam:
        class optimizer:
            type = "sgd"
            base_lr = 0.0001 #0.001 loss divergency
            momentum = 0.9
            nesterov = True
            wd = 1e-3
            clip_grad_norm = 10
